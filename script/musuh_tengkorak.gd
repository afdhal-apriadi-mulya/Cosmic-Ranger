...
var nyawa = dataBase.darahTengkorak
var dead = false
var kejar = true
var playerMasuk = false
var jenisAnim = 1
var damage = dataBase.damageTengkorak
var arah
var arahAnim
var tujuan
var offset
...
func kenaHit(_type, damageDiterima, kekuatanPental,  posisiSenjata):
	...
	if(nyawa <= 0 && !dead):
		...
		koin.global_position = tengkorak.global_position
...
func penyesuaianMusuh():
	if (self.name == "tengkorak"):
		nyawa = dataBase.darahTengkorak
		damage = dataBase.damageTengkorak
		jumlahAnim = 3
	elif (self.name == "tengkorak_kuning"):
		nyawa = dataBase.darahTengkorak_kuning
		damage = dataBase.damageTengkorak_kuning
		jumlahAnim = 2
	elif (self.name == "tengkorak_putih"):
		nyawa = dataBase.darahTengkorak_putih
		damage = dataBase.damageTengkorak_putih
		jumlahAnim = 2
